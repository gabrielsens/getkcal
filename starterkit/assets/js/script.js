...
function handleSubmit(event) {
    ...
    const maintnence = Math.round(tmb * Number(activityLevel))

    const loseWeight = maintnence - 450;
    const gainWeight = maintnence + 450;
    ...
    <h2>Aqui está o resultado:</h2>
        ...
        <div class="result-content">
          <ul>
            <li>
              Seu metabolismo basal é de <strong>${Math.round(tmb)} calorias</strong>.
            </li>
            <li>
              Para manter o seu peso você precisa consumir em média <strong>${maintnence} calorias</strong>.
            </li>
            <li>
